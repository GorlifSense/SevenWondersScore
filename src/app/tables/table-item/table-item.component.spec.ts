...
describe('TableItemComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ TableItemComponent, TestHostComponent ]
    })
    .compileComponents();
  }));
  ...
  it('host component for tableItemComponent should be created', () => {
    expect(hostComponent).toBeTruthy();
  });

  xit('should throw an error if no input table', () => {
    // TODO emulate state with no table from the server?
    hostComponent.tableItemComponent.table = null;
    expect(hostFixture.detectChanges()).toThrow();
  });

  @Component({
    // tslint:disable-next-line:component-selector
    selector: `host-component`,
    template: `<bgr-table-item [table]="tables[0]"></bgr-table-item>`
  })
  class TestHostComponent {
    @ViewChild(TableItemComponent)
      public tableItemComponent: TableItemComponent;
